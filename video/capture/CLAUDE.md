# Chess Study — Lector de libros y Tablero de Análisis

Source: https://my-chess-study.vercel.app/
...
| `extracted/tokens.json` | Design tokens: 10 colors, 1 fonts, 2 headings, 0 CTAs |
...
- **Colors**: #10192D (accent), #F0F1F5 (bg-light), #769656 (accent), #EEEED2 (bg-light), #FFFFFF (bg-light), #000000 (bg-dark), #EF4343 (accent), #6B7C94 (neutral), #1842B4 (accent), #1E40AF (accent)
- **Fonts**: Outfit (200,300,400,500,600,700,800)
